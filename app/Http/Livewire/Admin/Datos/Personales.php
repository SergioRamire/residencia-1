...
class Personales extends Component
{
    ...
    {
        return [
            'user.rfc' => 'required|string|max:254',
            'user.curp' => 'required|string|max:254',
            'user.name' => 'required|string|max:254',
            'user.apellido_materno' => 'required|string|max:254',
            'user.apellido_paterno' =>'required|string|max:254',
            'user.sexo' => 'required',
            'user.email' => 'required|string|max:254',
            'user.correo_tecnm' => 'required|string|max:254',
            'user.estudio_maximo' => 'required|string|max:254',
            'user.carrera' => 'required|string|max:254',

            'user.area_id' =>'required',
            'user.clave_presupuestal' => 'required|string|max:254',
            'user.puesto' => 'required|string|max:254',
            'area.telefono' => 'required|string|max:254',
            'area.jefe' => 'required|string|max:254',
            'user.hora_entrada' => 'required',
            'user.hora_salida' => 'required',
            'user.tipo' =>'required|string|max:254',
