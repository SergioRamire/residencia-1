...
use App\Http\Livewire\Admin\ComplaintController;
use App\Http\Livewire\Admin\ContributionController;

use App\Http\Livewire\Admin\TranslationController;
...
Route::middleware(['auth:web', config('jetstream.auth_session'), 'verified'])->group(function () {
    ...
    // Route::get('/denuncias', fn () => view('dashboard'))->name('dashboard');
    // Route::get('/seguimiento', fn () => view('dashboard'))->name('dashboard');
    // Route::get('/adeudos', fn () => view('dashboard'))->name('dashboard');
    ...
    //     ->get('roles', RoleController::class)->name('roles');
        Route::middleware('can:user.denuncias')->prefix('participate')->name('participant.')
            ->get('denuncias', ComplaintController::class)->name('denuncias');
            Route::middleware('can:user.seguimiento')->prefix('participate')->name('participant.')
                ->get('seguimiento', TranslationController::class)->name('seguimiento');
            Route::middleware('can:user.adeudos')->prefix('participate')->name('participant.')
                ->get('adeudos', ContributionController::class)->name('adeudos');
