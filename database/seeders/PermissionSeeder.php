...
class PermissionSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        */
        ...
        Permission::create(['name' => 'limitAsignGrades.edit', 'human_name' => 'Fecha asignar calificaciones'])->assignRole(['Jefa de departamento','Coordinador']);
        ...
        Permission::create(['name' => 'activeinscription.show', 'human_name' => 'Activar Inscripción'])->assignRole(['Administrador', 'Jefa de departamento']);

        Permission::create(['name' => 'sendemail.show', 'human_name' => 'Visualizar emails'])->assignRole(['Jefa de departamento']);
        Permission::create(['name' => 'sendnotify.show', 'human_name' => 'Ver notificaciones'])->assignRole(['Jefa de departamento']);
        ...
        Permission::create(['name' => 'const_firmada.show', 'human_name' => 'Visualizar constacias firmadas'])->assignRole(['Administrador', 'Jefa de departamento']);
