    ...
    <div class="bg-[#FFE8FA] p-8 ">
        ...
        <div class="grid grid-rows-3 grid-flow-col gap-4">
            <div class="row- row-span-2">
                ...
                <div class="w-full">
                    <x-jet-label class="text-black">Fecha de acontecimiento <span class="text-red-600">*</span>
                    </x-jet-label>
                ...
                <div class="w-full">
                    <x-jet-label for="depart">Departamento de Gobierno <span class="text-red-600">*</span>
                    </x-jet-label>
        ...
        <div class="w-full py-4">
            <x-jet-button class="bg-[#BB2574]" wire:click.prevent=" update_area()" wire:loading.attr="disabled"
                form="courseForm">
                ENVIAR
            </x-jet-button>
        </div>
            ...
            <div class="row- row-span-2">
                ...
                <div class="w-full ">
                    <x-jet-label for="direc">Direccion <span class="text-red-600">*</span></x-jet-label>
                    <x-input.error wire:model="areas.direc" class="block mt-1 w-full" type="text" id="direc"
                        name="direc" for="areas.direc" required />
                </div>

                <div class="flex justify-center">

                    <div class="mt-2">
                        <img class="" src="{{ asset('img/map1.jpeg') }}">
                    </div>
                </div>
