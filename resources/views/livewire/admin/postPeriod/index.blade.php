        ...
        <div class="py-4 bg-white">
            <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div class="lg:text-center">
                    <p class="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-3xl">Activar inscripciones para los periodos</p>
                    <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">Periodos posibles a ofertar:</p>
                </div>
                @if (!empty($fecha))
                    <x-table>
                        <x-slot name="head">
