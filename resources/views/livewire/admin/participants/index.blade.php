                ...
                <x-table>
                    ...
                    @forelse($users as $u)
                        <tr wire:key="user-{{ $loop->index }}" wire:loading.class.delay="opacity-50">
                            ...
                            <x-table.cell>
                                <button  wire:click="view({{ $u->id }})" type="button" class="px-4 bg-white hover:text-white hover:bg-sky-800 text-black font-bold border border-sky-400 rounded shadow" >
                                    Ver
                                </button>
