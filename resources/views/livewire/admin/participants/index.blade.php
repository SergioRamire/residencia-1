                    ...
                    @forelse($users as $u)
                        <tr wire:key="user-{{ $loop->index }}" wire:loading.class.delay="opacity-50">
                            ...
                            <x-table.cell width='200' class="whitespace-nowrap">
                                <button  wire:click="view({{ $u->id }})" type="button" class="mr-1 px-4 bg-white hover:text-white hover:bg-[#1b396a] text-black font-bold border border-sky-400 rounded shadow" >
                                    Ver
                                </button>
                                <button  wire:click="edit({{ $u->id }})" type="button" class="ml-1 px-4 bg-white hover:text-white hover:bg-amber-500 text-black font-bold border border-amber-400 rounded shadow" >
                                    Editar
                                </button>
