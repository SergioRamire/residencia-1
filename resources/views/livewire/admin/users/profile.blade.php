        ...
        <div class="space-y-2">
            <div class="p-4 bg-blue-100 rounded-lg border border-[#1b396a] shadow-md sm:p-6 lg:p-8 ">
                ...
                <div class="flex justify-center mr-10">
                    <p class="bg-white rounded-md text-lg text-red-700 p-2"> * Recuerde reller su informacion faltante.</p>
                </div>
                @endif
                <form id="courseForm">
                    <div class="flex flex-col sm:flex-row sm:items-baseline sm:gap-x-1.5">
                        ...
                        <div class="mt-4 flex-1">
                            <div class="bg-white px-2 py-3 grid grid-cols-2 gap-2 transition ease-in-out hover:-translate-y-1 hover:scale-105 duration-300">
