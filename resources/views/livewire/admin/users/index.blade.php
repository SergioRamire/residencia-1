                ...
                <div class="md:w-1/2 md:flex space-y-2 md:space-y-0 md:space-x-2">
                    ...
                    <x-dropdown width="w-full" align="right" dropdownClasses="md:w-72" content-classes="py-1 bg-white divide-y">
                        ...
                        <x-slot name="content">
                            ...
                            <div class="block px-4 py-2 space-y-1">
                                <div>
                                    <x-jet-label for="estatus_filter" value="Estado"/>
                    ...
                    @forelse($users as $u)
                        <tr wire:key="user-{{ $u->id }}" wire:loading.class.delay="opacity-50">
                            ...
                            <x-table.cell class="text-center">
                                @if($u->estatus == 1)
                                <button wire:click="user_inhabilitar({{$u->id}})" title="Inhabilitar el usuario">
                                    <x-badge.basic value="Habilitado" color="green" large/>
                                </button>
                                @elseif($u->estatus == 0)
                               <button wire:click="user_habilitar({{$u->id}})" title="Habilitar el usuario">
