                    ...
                    @forelse($users as $u)
                        <tr wire:key="user-{{ $u->id }}" wire:loading.class.delay="opacity-50">
                            ...
                            <x-table.cell>
                                ...
                                <button wire:click="delete({{ $u->id }})" type="button" class="px-4 bg-white hover:text-white hover:bg-red-600 text-black font-bold border border-red-400 rounded shadow">
                                    Eliminar
                                </button>
                            </x-table.cell>
                        </tr>
