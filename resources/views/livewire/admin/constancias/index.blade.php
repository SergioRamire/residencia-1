                            ...
                            <div>
                                @if($g->calificacion > 69)
                                    <x-table.cell class="text-center">
                                        <button wire:click="descargarConstancia({{ $g->id }})" title="Descarga constancia en pdf" class="bg-gray-300 hover:bg-gray-400 text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
