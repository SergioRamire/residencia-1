                ...
                <div class="md:w-1/2 md:flex space-y-2 md:space-y-0 md:space-x-2">
                    ...
                    <x-dropdown width="w-full" align="right" dropdownClasses="md:w-72" content-classes="py-4 bg-white divide-y">
                        ...
                        <x-slot name="content">
                            ...
                            <div class="block px-4 py-2 space-y-1">
                                <div>
                                    <x-jet-label for="filtro_calificacion" value="Calificación"/>
                                    <x-input.select wire:model="filters.filtro_calificación" name="filtro_calificación" id="filtro_calificacion" class="text-sm block mt-1 w-full" required>
                            ...
                            <div class="block px-4 py-2 space-y-1">
                                <div>
                                    <x-jet-label for="filtro_año" value="Año"/>
                                    <x-input.select wire:model="filters.filtro_año" name="filtro_año" id="filtro_año" class="text-sm block mt-1 w-full" required>
