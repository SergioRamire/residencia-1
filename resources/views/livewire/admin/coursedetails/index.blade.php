    ...
    <div class="flex flex-col sm:flex-row sm:items-baseline sm:gap-x-1.5">
        ...
        <div class="md:flex md:justify-between space-y-2 md:space-y-0">
            ...
            <div class="md:w-1/2 md:flex space-y-2 md:space-y-0 md:space-x-2">
                ...
                <!-- Filtros -->
                <x-dropdown width="w-full" align="right" dropdownClasses="md:w-72"
                    content-classes="py-1 bg-white divide-y">
                    <x-slot name="trigger">
                        <button
                    ...
                    <x-slot name="content">
                        ...
                        <div class="block px-4 py-2 space-y-1">
                            <div>
                                ...
                                <x-input.select wire:model="filters.curso" id="departamento_filter"
                                    class="text-sm block mt-1 w-full" name="departamento_filter" required>
                                    <option value="" disabled>Selecciona el curso...</option>
                                    @foreach (\App\Models\CourseDetail::join('courses', 'courses.id', '=', 'course_details.course_id')->join('periods', 'periods.id', '=', 'course_details.period_id')->where('course_details.period_id', '=', $classification['periodo'])->select('course_details.course_id as id', 'courses.nombre')->get() as $course)
