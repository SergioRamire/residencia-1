            ...
            <h5 class="text-xl font-medium text-blue-600"></h5>
                <div class="m-4">
                    <div class="p-2 bg-white rounded-lg border border-gray-200 shadow-md sm:p-3 lg:p-4 ">
                        <p class="text-justify"><strong>Recuerde que,</strong> para aprobar y obtener la constancia de acreditación por curso debe de, cumplir con el <strong>mínimo de asistencias</strong>
